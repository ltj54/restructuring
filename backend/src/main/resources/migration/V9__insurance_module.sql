...
-- Adds user_insurance_profile and refreshes catalog seed data (idempotent-friendly)
-- ================================================

-- --------------------------
-- USER INSURANCE PROFILE (hva har brukeren fra før?)
-- --------------------------
CREATE TABLE IF NOT EXISTS user_insurance_profile (
...
CREATE INDEX IF NOT EXISTS idx_user_insurance_profile_user_id
    ON user_insurance_profile (user_id);
